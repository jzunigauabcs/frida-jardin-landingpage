...
<body>
      ...
      <div class="row">
        ...
        <div class="container col-8 d-none d-lg-block text-center">
          <div class="row align-items-end h-100 gx-3 menu-option">
            <div class="col">
              <a href="#tu-visita" class="link-light link-underline link-underline-opacity-0"><p class="h4"><?php echo transl('section-visit') ?></p></a>
            </div>
            <div class="col">
              <a href="#boletos" class="link-light link-underline link-underline-opacity-0"><p class="h4"><?php echo transl('section-tickets') ?></p></a>
            </div>
            <div class="col">
              <a href="#jardin-secreto" class="link-light link-underline link-underline-opacity-0"><p class="h4"><?php echo transl('section-garden') ?></p></a>
            </div>
			<div class="col">
              <a href="#calendario" class="link-light link-underline link-underline-opacity-0"><p class="h4"><?php echo transl('section-events') ?></p></a>
            </div>
            <div class="col">
              <a href="#grupos" class="link-light link-underline link-underline-opacity-0"><p class="h4"><?php echo transl('section-groups') ?></p></a>
            </div>
            <div class="col">
              <a href="#servicios" class="link-light link-underline link-underline-opacity-0"><p class="h4"><?php echo transl('section-services') ?></p></a>
            </div>
            ...
            <div class="row h-100">
              ...
              <div class="col-2 h-100 position-relative">
                ...
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="#tu-visita"><?php echo transl('section-visit') ?></a></li>
                  <li><a class="dropdown-item" href="#boletos"><?php echo transl('section-tickets') ?></a></li>
                  <li><a href="#jardin-secreto" class="dropdown-item"><?php echo transl('section-garden') ?></a></li>
                  <li><a href="#calendario" class="dropdown-item"><?php echo transl('section-events') ?></a></li>
                  <li><a class="dropdown-item" href="#grupos"><?php echo transl('section-groups') ?></a></li>
                  <li><a class="dropdown-item" href="#servicios"><?php echo transl('section-services') ?></a></li>
					<li>
                    <form method="post">
            ...
            <div class="frame-1">
              <div class="frame-2">
                <div class="presentation">
                    <h2><?php echo transl('main-presentation') ?></h2>
        ...
        <div class="col-md-12 col-lg-4 pb-3">
          <section class="square mx-auto">
            <div class="frame-1">
              <div class="frame-2">
                <div class="presentation">
                  <h2><?php echo transl('main-tickets') ?></h2>
                  <a href="https://fridaensujardinsecreto.com/producto/frida-khalo-recorrido/" class="btn btn-primary btn-lg border-0 py-3 comprar-btn"><?php echo transl('btn-buy') ?></a>
                </div>
              </div>
            </div>
          </section>
    ...
    <div class="container">
      <div class="row align-items-start poppins-regular">
        ...
        <div class="col-sm-12 col-md-12 col-lg-5 px-5">
          <h1 class="pink-title pb-5 txt-titulo lobster"><?php echo transl('section-visit') ?></h1>
          <h5 class="py-3 poppins"><?php echo transl('visit-txt-schedules') ?></h5>
          <div class="row">
              <p><?php echo transl('visit-schedules') ?></p>
          </div>
          <div class="vertical-line"></div>
        </div>

        <div class="col-sm-12 col-md-12 col-lg-3 px-5 custom-border-start">
          <h5 class="pt-2 poppins"><?php echo transl('visit-txt-admissions') ?></h5>
          <div class="row py-3">
            <h5 class="pb-3 tu-visita-tarifas"><?php echo transl('visit-admission-txt-general') ?></h5>
            <div class="mb-1"><p><?php echo transl('visit-admission-national') ?></p></div>
            <div class="mb-1"><p><?php echo transl('visit-admission-foreign') ?></div>
            <div class="mb-1"><p><?php echo transl('visit-admission-special') ?></p></div>
            <div class="mb-1"><p><?php echo transl('visit-admission-scholar') ?></p></div>
            
          </div>
          <div class="row py-3">
            <h5 class="pb-3 tu-visita-tarifas"><?php echo transl('visit-txt-tour') ?></h5>
            <div lass="mb-1"><p><?php echo transl('visit-tour-discount') ?></p></div>
          </div>
        </div>
        ...
        <div class="col-sm-12 col-md-12 col-lg-4 px-5">
          ...
          <div class="row py-3">
            <h5 class="pb-3 tu-visita-tarifas"><?php echo transl('visit-txt-free') ?></h5>
            <div class="mb-1"><p><?php echo transl('visit-free-kids') ?></p></div>
          </div>
    ...
    <div class="container section-padding">
      <div id="boletos-parte-1" class="row align-items-start">
        <div class="col-sm-12 col-md-12 px-5 pb-4">
          <h1 class="white-title txt-titulo lobster"><?php echo transl('section-tickets') ?></h1>	
          <hr class="linea-horizontal-blanca"/>
        </div>

        <div class="col-sm-12 col-md-12 col-lg-6 px-5 text-white pb-4 poppins">
          <div class="row">
            <p><?php echo transl('tickets-description') ?></p>
          </div>

          <h5 class="py-3"><?php echo transl('tickets-schedules') ?></h5>

          <div class="row">
            <p class="mb-1 poppins-regular"><?php echo transl('layout-date-mon-sun') ?>: <?php echo transl('layout-hour-8-20') ?></p>
          </div>

          <div id="boletos-parte-2" class="row pt-5">
            <p><?php echo transl('tickets-steps') ?></p>
            <ul class="px-5">
              <li><?php echo transl('tickets-step-1') ?></li>
              <li><?php echo transl('tickets-step-2') ?></li>
            </ul>
            <p><?php echo transl('tickets-thanks') ?></p>
          </div>
        </div>
        ...
        <div class="col-sm-12 col-md-12 col-lg-6 px-5 text-white pb-4 poppins">
          <div class="row">
            ...
            <div id="boletos-parte-2" class="row">                 
              <p><?php echo transl('tickets-notallowed') ?></p>
              <ul class="px-5">
                <li><?php echo transl('tickets-notallowed-1') ?></li>
                <li><?php echo transl('tickets-notallowed-2') ?></li>
                <li><?php echo transl('tickets-notallowed-3') ?></li>
                <li><?php echo transl('tickets-notallowed-4') ?></li>
              </ul>

              <p><?php echo transl('tickets-onceinside') ?></p>
              <ul class="px-5">
                <li><?php echo transl('tickets-onceinside-1') ?></li>
                <li><?php echo transl('tickets-onceinside-2') ?></li>
              </ul>
            </div>
          </div>
        </div>
              ...
              <div class="row">
                ...
                <div class="col-12 col-lg-6 pe-5">
                  <div class="row">
                    <div class="col px-5">
                      <div class="row py-5">
                        <h1 class="white-title lobster"><?php echo transl('title') ?></h1>
                      </div>
                      <div class="row pb-5">
                        <p class="slider-p too-much-text">
                          <?php echo transl('slider-page-1-txt-1') ?>
                        </p>
                        <p class="slider-p too-much-text">
                          <?php echo transl('slider-page-1-txt-2') ?>
                        </p>
                        <p class="slider-p too-much-text">
                          <?php echo transl('slider-page-1-txt-3') ?>
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-12 col-lg-6 pe-5">
                  <div class="row">
                    <div class="col px-5">
                      ...
                      <div class="row pb-5">
                        <p class="slider-p too-much-text">
                          <?php echo transl('slider-page-2-txt-1') ?>
                        </p>
                        <p class="slider-p too-much-text">
                          <?php echo transl('slider-page-2-txt-2') ?>
                        </p>
                        <p class="slider-p too-much-text">
                          <?php echo transl('slider-page-2-txt-3') ?>
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-12 col-lg-6 pe-5">
                  <div class="row">
                    <div class="col px-5">
                      ...
                      <div class="row pb-5">
                        <p class="slider-p too-much-text">
                          <?php echo transl('slider-page-3-txt-1') ?>
                        </p>
                        <p class="slider-p too-much-text">
                          <?php echo transl('slider-page-3-txt-2') ?>
                        </p>
                        <p class="slider-p too-much-text">
                          <?php echo transl('slider-page-3-txt-3') ?>
                        </p>
                      </div>
                    </div>
                  </div>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-10 col-lg-7 bg-orange custom-border">
          <h1 class="white-title p-3 txt-titulo lobster"><?php echo transl('events-header') ?></h1>
        </div>
      </div>
    </div>
        ...
        <div class="col-sm-12 col-lg-9">
          ...
          <div class="row p-3" style="border-bottom: 3px dotted white;">
            <div class="col-sm-12 col-lg-2 text-wrap lobster">
              <h5><?php echo transl('events-date-1') ?></h5>
            </div>
            <div class="col-sm-12 col-lg-10 poppins" style="padding-left: 30px;">
              <p class="p-0 m-0"> <?php echo transl('events-activity-1') ?></p>
            </div>
          </div>

          <div class="row p-3" style="border-bottom: 3px dotted white;">
            <div class="col-sm-12 col-lg-2 text-wrap lobster">
              <h5><?php echo transl('events-date-2') ?></h5>
            </div>
            <div class="col-sm-12 col-lg-10 poppins"  style="padding-left: 30px;">
              <p class="p-0 m-0"><?php echo transl('events-txt-activity') ?></p>
              <p class="p-0 m-0">* <?php echo transl('events-activity-2-1') ?></p>
              <p class="p-0 m-0">* <?php echo transl('events-activity-2-2') ?></p>
            </div>
          </div>

          <div class="row p-3" style="border-bottom: 3px dotted white;">
            <div class="col-sm-12 col-lg-2 text-wrap lobster">
              <h5><?php echo transl('events-date-3') ?></h5>
            </div>
            <div class="col-sm-12 col-lg-10 poppins" style="padding-left: 30px;">
              <p class="p-0 m-0"><?php echo transl('events-activity-3') ?></p>
            </div>
          </div>

          <div class="row p-3" style="border-bottom: 3px dotted white;">
            <div class="col-sm-12 col-lg-2 text-wrap lobster">
              <h5><?php echo transl('events-date-4') ?></h5>
            </div>
            <div class="col-sm-12 col-lg-10 poppins" style="padding-left: 30px;">
              <p class="p-0 m-0"><?php echo transl('events-activity-4') ?></p>
            </div>
          </div>

          <div class="row p-3">
            <div class="col-sm-12 col-lg-2 text-wrap lobster">
              <h5><?php echo transl('events-date-5') ?></h5>
            </div>
            <div class="col-sm-12 col-lg-10 poppins" style="padding-left: 30px;">
              <p class="p-0 m-0"><?php echo transl('events-txt-activity') ?></p>
              <p class="p-0 m-0">* <?php echo transl('events-activity-5-1') ?></p>
              <p class="p-0 m-0">* <?php echo transl('events-activity-5-2') ?></p>
              <p class="pt-4 m-0" style="font-size: 15px;"><?php echo transl('events-info') ?></p>
            </div>
          </div>
        </div>
  ...
  <div id="grupos" class="container-fluid px-0 bg-white">
    <div class="container section-padding">
        <h1 class="pink-title pb-5 txt-titulo lobster"><?php echo transl('section-groups') ?></h1>
        
        <div class="row pt-5">
          <div class="col-sm-12 col-lg-4 text-wrap poppins">
            <h5><?php echo transl('groups-txt-school') ?></h5>
          </div>
          <div class="col-sm-12 col-lg-8 px-5 custom-border-start poppins-regular">
            <p class="pb-4"><?php echo transl('groups-school') ?></p>
          </div>
        </div>
        
        <div class="row">
          <div class="col-sm-12 col-lg-4 text-wrap poppins">
            <h5><?php echo transl('groups-txt-community') ?></h5>
          </div>
          <div class="col-sm-12 col-lg-8 px-5 custom-border-start poppins-regular">
            <p class="pb-4"><?php echo transl('groups-community') ?></p>
          </div>
        </div>
        
        <div class="row">
          <div class="col-sm-12 col-lg-4 text-wrap poppins">
            <h5><?php echo transl('groups-txt-private') ?></h5>
          </div>
          <div class="col-sm-12 col-lg-8 px-5 custom-border-start poppins-regular">
            <p><?php echo transl('groups-private') ?></p>
          </div>
        </div>
    </div>
  </div>
  ...
  <div id="servicios" class="container-fluid section-wall-bg section-padding px-0 py-0">
    ...
    <div class="container d-none">
      <h1 class="white-title txt-titulo lobster"><?php echo transl('section-services') ?></h1>
    </div>
                  ...
                  <section class="square mx-auto">
                    <div class="frame-1">
                      <div class="frame-2">
                        <div class="presentation">
                          <div class="row">
                            <h2><?php echo transl('services-block-rosita') ?></h2>
                          </div>
                          <div class="row blue-content">
                            <p><?php echo transl('layout-date-upcoming') ?></p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <section class="square mx-auto">
                    <div class="frame-1">
                      <div class="frame-2">
                        <div class="presentation">
                          <div class="row">
                            <h2><?php echo transl('layout-shop') ?></h2>
                          </div>
                          <div class="row services-poppins">
                            <p><?php echo transl('services-block-shop') ?></p>
                            <p class="blue-content"><b><?php echo transl('layout-date-mon-sun') ?></b><br>
                            <?php echo transl('layout-hour-8-20') ?></p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <section class="square mx-auto">
                    <div class="frame-1">
                      <div class="frame-2">
                        <div class="presentation">
                          <div class="row">
                            <h2><?php echo transl('services-block-doce') ?></h2>
                          </div>
                          <div class="row services-poppins">
                            <p><?php echo transl('services-block-doce-txt') ?></p>
                            <p class="blue-content"><b>?php echo transl('layout-date-mon-sun') ?></b><br>
                            <?php echo transl('layout-hour-8-20') ?></p>
                          </div>
                        </div>
  ...
  <div id="contactanos" class="container-fluid section-padding px-0 bg-white">
    <div class="container">
      ...
      <div class="row">
        <h1 class="txt-titulo text-break pink-title lobster"><?php echo transl('section-contact') ?></h1>
      ...
      <div class="row">  
        ...
        <div id="contactanos" class="col-sm-12 col-md-12 col-lg-6 p-5 poppins-regular">
          <div class="row">
            <p class="pb-3"><?php echo transl('contact-txt-arrive') ?></p>
          </div>
          <div class="row">
            <h6 class="contactanos-datos"><?php echo transl('contact-txt-address') ?></h6><br><p><?php echo transl('contact-address') ?></p>
          </div>
          <div class="row">
            <h6 class="contactanos-datos"><?php echo transl('contact-txt-phone') ?></h6><br><p>612 128 8032</p>
          </div>
          <div class="row text-wrap pb-3">
            <h6 class="contactanos-datos"><?php echo transl('contact-txt-mail') ?></h6><br><p class="text-break">contacto@fridaensujardinsecreto.com</p>
          </div>
          <form class="pb-5">
            <div class="row">
              <div class="col-md-3">
                <div class="mb-3">
                  <label for="nombre" class="form-label"><?php echo transl('contact-txt-name') ?>:</label>
                </div>
              </div>
              <div class="col-md-9">
                <div class="mb-3">
            ...
            <div class="row">
              <div class="col-md-3">
                <div class="mb-3">
                  <label for="correo" class="form-label"><?php echo transl('contact-txt-mail') ?>:</label>
                </div>
              </div>
              <div class="col-md-9">
                <div class="mb-3">
            ...
            <div class="row">
              <div class="col-md-3">
                <div class="mb-3">
                  <label for="mensaje" class="form-label"><?php echo transl('contact-txt-message') ?>:</label>
                </div>
              </div>
              <div class="col-md-9">
                <div class="mb-3">
            ...
            <div id="contactanos-terminos-condiciones"class="mb-3 form-check pb-3">
              ...
              <label class="form-check-label" for="exampleCheck1"><?php echo transl('contact-txt-agree') ?></label>
            </div>
            <button type="submit" class="btn btn-primary rounded-pill border-0 px-4 bg-pink"><?php echo transl('btn-send') ?></button>
          </form>
          <div id="oferta-trabajo" class="p-3 rounded-4 bg-5">
            <p class="m-0"><?php echo transl('contact-txt-offer-1') ?></p>
            <p class="m-0"><?php echo transl('contact-txt-offer-2') ?></p>
            <p class="m-0"><?php echo transl('contact-txt-offer-3') ?></p>
            <p class="m-0"><?php echo transl('contact-txt-offer-4') ?></p>
            <p class="m-0 text-break"><?php echo transl('contact-txt-offer-5') ?></p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-8">
          <div class="row">
            <div class="col-12 col-lg-4">
              <div class="row pb-3">
                <p class="h1 footer-titles"><?php echo transl('layout-links') ?></p>
              </div>
              <div class="row pb-3">
                <h4><a href="#tu-visita" class="link-light link-underline link-underline-opacity-0"><?php echo transl('section-visit') ?></a></h4>
              </div>
              <div class="row pb-3">
                <h4><a href="#jardin-secreto" class="link-light link-underline link-underline-opacity-0"><?php echo transl('section-garden') ?></a></h4>
              </div>
              <div class="row pb-3">
                <h4><a href="#grupos" class="link-light link-underline link-underline-opacity-0"><?php echo transl('section-groups') ?></a></h4>
              </div>
              <div class="row pb-3">
                <h4><a href="#contactanos" class="link-light link-underline link-underline-opacity-0"><?php echo transl('section-contact') ?></a></h4>
              </div>
            </div>

            <div class="col-12 col-lg-4">
              <div class="row pb-3">
                <p class="h1 footer-titles"><?php echo transl('layout-services') ?></p>
              </div>
              <div class="row pb-3">
                <h4><a href="#servicios" class="link-light link-underline link-underline-opacity-0"><?php echo transl('layout-restaurant') ?></a></h4>
              </div>
              <div class="row pb-3">
                <h4><a href="#servicios" class="link-light link-underline link-underline-opacity-0"><?php echo transl('layout-garden-shop') ?></a></h4>
              </div>
              <div class="row pb-3">
                <h4><a href="#servicios" class="link-light link-underline link-underline-opacity-0"><?php echo transl('layout-coffee') ?></a></h4>
              </div>
            </div>

            <div class="col-12 col-lg-4">
              <div class="row pb-3">
                <p class="h1 footer-titles"><?php echo transl('layout-social') ?></p>
              </div>
              <div class="row pb-3">
  ...
  <div class="container-fluid px-0 bg-pink">
    <div class="container">
      <div class="row py-3 text-center">
        ...
        <div class="col-6 col-md-3 extra"><?php echo transl('footer-copyright') ?></div>
        <div class="col-6 col-md-3">
          <button type="button" class="btn btn-primary no-button-style p-0 extra" data-bs-toggle="modal" data-bs-target="#avisoPrivacidad">
            <p class="white-poppins m-0"><?php echo transl('footer-privacy') ?></p>
          </button>
        ...
        <div class="col-6 col-md-3">
          <button type="button" class="btn btn-primary no-button-style p-0 extra" data-bs-toggle="modal" data-bs-target="#exampleModal">
            <p class="white-poppins m-0" ;><?php echo transl('footer-cancellation') ?></p>
          </button>
